...
function Update(time)
	if probability > 0.5 then
        ...
        Call("svetlo1:Activate",1)
        Call("svetlo2:Activate",1)
        Call("svetlo3:Activate",1)
        Call("svetlo4:Activate",1)
	else
		Call("ActivateNode", "svetlo", 0)
        Call("svetlo1:Activate",0)
        Call("svetlo2:Activate",0)
        Call("svetlo3:Activate",0)
        Call("svetlo4:Activate",0)
	end
end